                            ...
                            success : function(response){
                                if(response.dataset.today_log.length > 0){
                                    ...
                                    for(var i=0;i<response.dataset.today_log.length;i++){
                                        ...
                                        str_tabel += '<td>' + parseFloat(response.dataset.today_log[i].ketinggian).toFixed(2) + ' cm dari dasar</td>';
                                        str_tabel += '<td>' + parseFloat(response.dataset.today_log[i].volume).toFixed(2) + ' cm<sup>3</sup></td>';

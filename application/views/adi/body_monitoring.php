                    ...
                    function refresh_data(){
                        $.ajax({
                              ...
                              success : function(response){
                                    ...
                                    if((parseInt(response.dataset.last_data[0].ketinggian) > 15 && parseInt(response.dataset.last_data[0].notif) === 1)||(parseInt(response.dataset.last_data[0].ketinggian) < 5 && parseInt(response.dataset.last_data[0].notif) === 3)) {
                                        snd.play();
                                    }     
                            }
                        });
